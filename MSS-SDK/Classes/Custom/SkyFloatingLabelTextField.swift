...
//    @objc dynamic open var titleFont: UIFont = UIFont(name: "Century Gothic", size: 12)! {
//        didSet {
//            updateTitleLabel()
//        }
//    }
...
// *********KASHIF       titleLabel.font = titleFont
        titleLabel.alpha = 0.0
        
        
        //        titleLabel.font = UIFont(name: "Papyrus", size: 13)!
    ...
    fileprivate func updateTitleLabel(_ animated: Bool = false) {
        ...
        //        titleLabel.font = UIFont(name: "CenturyRegular.ttf", size: 10.0)
