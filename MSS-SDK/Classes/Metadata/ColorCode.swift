...
class ColorCode {
    ...
    static let primaryColor = "#424141"
    static let primaryColorLight = "#b478ec"
    static let primaryDarkColor = "#2E2D2D"
    ...
    static let cardShadow = "#AEADAD"
    
    //Button
    static let btn_back = "#2e2d2d"
    static let btn_fb = "#385C8E"
    static let btn_google = "#F63420"
    static let btn_on_click = "#2e2d2d"
    
    
    static let btn_in_active = "#FEBBBB"
    static let btn_in_active_border = "#F63420"
    ...
    //TextField
    static let txtDefault = "#FFFFFF"
    static let txtError = "#B41B03"
    static let txtSuccess = "#099256"
    static let txtInActive = "#FFFFFF"
